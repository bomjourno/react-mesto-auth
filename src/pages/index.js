...
const popupWithConfirmation = new PopupWithConfirmation('.popup_delete-card', (card) => {
...
const userProfilePopup = new PopupWithForm('.popup_edit-profile', (data) => {
...
const popupChangeAvatar = new PopupWithForm('.popup_change-avatar', (data) => {
...
const getStartCard = () => {
  api
    ...
    .then((data) => {
      ...
      const startCardArrSorted = startCardArr.sort(
